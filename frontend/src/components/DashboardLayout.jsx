        ...
        items: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { text: "Salary Head Master", path: "/contractors/salary-heads" },
                    { text: "Salary Structure", path: "/contractors/salary-structure" },
                    { text: "Monthly Salary Sheets", path: "/contractors/salary-sheets" },
                    { text: "Advance / Loan Memo", path: "/contractors/advances" },
                    { text: "Voucher Payments", path: "/contractors/vouchers" },
                ],
            },
        ],
    },
...
function getPageTitle(pathname) {
    const titles = {
        ...
        "/contractors/salary-heads": "Contractor Salary Head Master",
        "/contractors/salary-structure": "Contractor Salary Structure",
        "/contractors/salary-sheets": "Contractor Monthly Salary Sheets",
        "/contractors/advances": "Contractor Advance / Loan Memo",
        "/contractors/vouchers": "Contractor Voucher Payments",
